...
#         self.spks = self.generator.spks  # 기본 값은 None임
...
class JETS(AbsGANTTS):
    ...
    def __init__(
        ...
        self.langs = self.generator.langs
        self.spk_embed_dim = self.generator.spk_embed_dim
        self.use_gst = getattr(self.generator, "use_gst", True) # 여기 False 였는데 True로 바꿈
    ...
    def _forward_generator(
        ...
        **kwargs,
        ...
        loss = g_loss + var_loss + align_loss + vq_loss
